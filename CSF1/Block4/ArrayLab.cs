...
namespace Block4
{
    internal class ArrayLab
    {
        static void Main(string[] args)
        {
            ...
            Console.Clear();
            Console.WriteLine("\n Score 2: " + scoreIndex[0] + " \n Please Enter Next Score.\n");

            scoreIndex[1] = Console.ReadLine();
            Console.Clear();
            Console.WriteLine("\n Score 3: " + scoreIndex[1] + " \n Please Enter Next Score.\n");

            scoreIndex[2] = Console.ReadLine();
            Console.Clear();
            Console.WriteLine("\n Score 4: " + scoreIndex[2] + " \n Please Enter Next Score.\n");

            scoreIndex[3] = Console.ReadLine();
            Console.Clear();
            Console.WriteLine("\n Score 5: " + scoreIndex[3] + " \n Thank You!\n");

            scoreIndex[4] = Console.ReadLine();
            Console.WriteLine();

            
                Array.Sort(scoreIndex);
            Console.WriteLine("Index " + scoreIndex);
            //Console.WriteLine(Array.Sort(scoreIndex));
